...
middleLayers = [
    ...
    convolution2dLayer(filterSize, 128, 'Padding', 2,'Name','conv_4',...
    'WeightsInitializer','narrow-normal')
...
%{
    ...
    convolution2dLayer(filterSize, 128, 'Padding', 1,'Name','conv_12',...
    'WeightsInitializer','narrow-normal')
...
lgraph = yolov2Layers(input_size,numClasses,Anchors,lgraph,'relu_4');
...
%%
% train the detector
[THAnet_768x512, info] = trainYOLOv2ObjectDetector(cds,lgraph,options);
